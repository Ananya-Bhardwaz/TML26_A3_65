...
API_KEY = "613bfba4b9ba5a4c6bce1eeecb39f227"  # replace with your actual API key

MODEL_PATH = "checkpoints/final_best_submission_resnet50.pt" # replace with your actual model path
